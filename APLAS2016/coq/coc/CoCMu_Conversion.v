(***************************************************************************
* CoC + Mu + Type-in-type - Properties of Conversion                       *
* Based on CoC formalization in LibLN by                                   *
*   Arthur Chargueraud, April 2007                                         *
***************************************************************************)

Set Implicit Arguments.
Require Import LibLN CoCMu_Definitions CoCMu_Infrastructure 
 CoCMu_BetaStar CoCMu_ChurchRosser.
...
Lemma beta_star_type_any_inv : forall P,
  (beta star) (trm_star) P -> P = trm_star.
Proof.
  introv R.
  gen_eq T: (trm_star). 
...
Lemma conv_type_type_inv :
  conv (trm_star) (trm_star).
Proof.
  apply* equiv_refl.
Qed.

Lemma conv_type_prod_inv : forall U1 U2,
  conv (trm_star) (trm_prod U1 U2) -> False.
Proof.
  unfold conv. introv C.
  destruct (church_rosser_beta C) as [P3 [Red1 Red2]].
  destruct (beta_star_prod_any_inv Red2)
