...
which is proposed by~\cite{cook1989denotational} in an untyped setting.
...
\lstinputlisting[linerange=-]{}% APPLY:linerange=DESUGAR1
becomes
\begin{lstlisting}
...
closely follows the semantics presented by~\cite{alpuimdisjoint}. It consists
...
been presented~\cite{alpuimdisjoint}, we have an additional rule, which we
