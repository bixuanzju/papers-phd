...
\cite{oliveira2012extensibility} proposed a design pattern that can solve the
...
\lstinputlisting[linerange=-]{}% APPLY:linerange=CHURCH_DEF
An attentive reader may immediately recognize this is a variant of the \textsc{Visitor}
pattern. Indeed, as already noted by \cite{oliveira2012extensibility}, Object
...
\lstinputlisting[linerange=-]{}% APPLY:linerange=EXPRESSION1_EG
...
\lstinputlisting[linerange=-]{}% APPLY:linerange=PRINT_IMPL
...
as follows:
\lstinputlisting[linerange=-]{}% APPLY:linerange=EVAL_PRINT
...
%\lstinline{ExtExp}:
\lstinputlisting[linerange=-]{}% APPLY:linerange=EXPRESSION2_EG
...
\lstinputlisting[linerange=-]{}% APPLY:linerange=VISITOR_EG
...
\cite{oliveira2012extensibility} addressed this problem by proposing
...
\subsubsection{Boilerplate-free composition of Object Algebras}
...
\lstinputlisting[linerange=50-50]{../../examples/visitor3.sl}% APPLY:linerange=COMBINE_DEF
...
\lstinputlisting[linerange=58-61]{../../examples/visitor3.sl}% APPLY:linerange=COMBINE1_TEST
...
is rejected:
\lstinputlisting[linerange=-]{}% APPLY:linerange=EXPRESSION_WRONG
...
\lstinputlisting[linerange=-]{}% APPLY:linerange=DC_DEF
