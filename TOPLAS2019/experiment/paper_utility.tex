...
\newcommand{\staticA}{\static_1}
\newcommand{\staticB}{\static_2}
\newcommand{\gradual}{\mathcal{G}}
\newcommand{\gradualA}{\gradual_1}
\newcommand{\gradualB}{\gradual_2}
\newcommand{\scastable}{\mathbb{S}}
\newcommand{\scastableA}{\scastable_1}
\newcommand{\scastableB}{\scastable_2}
\newcommand{\gcastable}{\mathbb{G}}
\newcommand{\gcastableA}{\gcastable_1}
\newcommand{\gcastableB}{\gcastable_2}
\newcommand{\gsubst}{S^\gradual}
\newcommand{\ssubst}{S^\static}
\newcommand{\psubst}{S^\mathcal{P}}
\newcommand{\pbctype}{U}
\newcommand{\pbctypeA}{\pbctype_1}
\newcommand{\pbctypeB}{\pbctype_2}
